---
outline: deep
description: Система логирования C Web Framework. Поддержка всех уровней syslog, настраиваемая фильтрация и запись в системный журнал syslog.
---
...
::: warning Важно
Секция `log` обязательна — оба поля (`enabled` и `level`) должны присутствовать. При отсутствии любого из них загрузка конфигурации завершится с ошибкой.
:::
...
Все сообщения записываются в системный журнал syslog и обычно доступны в файле `/var/log/syslog`.
