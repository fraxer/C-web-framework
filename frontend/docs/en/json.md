---
outline: deep
description: C Web Framework JSON library. Parsing, generation, working with objects and arrays. Thread-safe operations and Unicode support.
---

# JSON library

A high-performance library for working with the JSON format. Supports parsing, generation, modification, and serialization of JSON documents.
