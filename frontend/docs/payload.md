...
::: tip Дальше — валидация
Методы `get_payload*` возвращают сырые строки. Для очистки, типизации и проверки входных данных — длины, формата, диапазонов, файлов и связи полей между собой — используйте модуль форм, описанный в разделе [Обработка входных данных](/forms).
:::
