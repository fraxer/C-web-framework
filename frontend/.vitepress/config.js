...
export default defineConfig({
  ...
  head: [
    ...
    [
      'link', { rel: "icon", type: "image/x-icon", href: "https://cwebframework.tech/favicon.ico"}
    ]
  ],
  locales: {
    root: {
      ...
      themeConfig: {
        logo: 'https://cwebframework.tech/favicon.png',
        siteTitle: 'C Web Framework (альфа)',
    ...
    en: {
      ...
      themeConfig: {
        logo: 'https://cwebframework.tech/favicon.png',
        siteTitle: 'C Web Framework (alpha)',
