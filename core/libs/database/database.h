...
typedef struct dbconnection {
    ...
    str_t*(*quote_string)(void* connection, str_t* string);
} dbconnection_t;
...
typedef struct dbgrammar {
    ...
    char*(*compile_select)(void* connection, const char* table, array_t* columns, array_t* params);
    char*(*compile_update)(void* connection, const char* table, array_t* set, array_t* params);
    char*(*compile_delete)(void* connection, const char* table, array_t* params);
} dbgrammar_t;
